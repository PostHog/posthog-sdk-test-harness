...
- **Breaking**: V1 capture endpoint path updated from `/i/v1/e` to `/i/v1/analytics/events` throughout mock server and test suite
...
- V1 test suite covering the full `/i/v1/analytics/events` contract:
